                ...
                <div className="page-container">
                    ...
                    <div className="row">
                        <div className="col-md-8">
                            ...
                            <p>And for those curious, the <a href="./powerRankings.html">power rankings</a> contains how the AI will rate each card's power level (numbers chosen slightly arbitrarily by me). Go have a look and shout at me if you disagree! It's difficult to truly get a feel for the power level of the cards without playtesting, so expect this page to change a lot!</p>
